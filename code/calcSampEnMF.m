...
r = e*std2(img); %Calculate tolerance case grayscale image
...
limit=90;   %Number of random windows (defined by [5])
rest=0;
            ...
            if C>1 
                ...
                for k=1:m
                 ...
                 if color_r==0
                    ...
                    u=double(exp(-((D(1,1)^2)/(2*(color_r^2))))); %Equation 12 according [5]
                 end  
